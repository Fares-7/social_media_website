                ...
                <div class="card mb-4 tweet-card">
                    <div class="card-body">
                        <form action="{{ route('tweets.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <textarea name="text" class="form-control border-0" rows="3" placeholder="What's happening?" required></textarea>
                            </div>
                        ...
                        <div class="card mb-3 tweet-card">
                            <div class="card-body">
                                ...
                                <div class="interaction-buttons d-flex gap-3">
                                    ...
                                    <!-- Comment Button -->
                                    <button class="btn btn-sm btn-outline-secondary rounded-pill" data-bs-toggle="collapse"
                        ...
                        @foreach ($users as $user)
                            <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
                                ...
                                <form
                                    ...
                                    @endif
                                    <button type="submit"
                                        class="btn btn-sm {{ auth()->user()->isFollowing($user) ? 'btn-outline-danger' : 'btn-primary' }} rounded-pill">
